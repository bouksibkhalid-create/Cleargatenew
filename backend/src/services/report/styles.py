...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "fr": {
        ...
        "methodology_osint_title": "Recherche en sources ouvertes",
        ...
        "methodology_dorking_title": "Recherche approfondie sur Internet",
        "methodology_dorking_desc": "Utilisation de techniques de recherche avancées pour identifier des documents, fuites de données, et informations enfouies non indexées par les moteurs de recherche standards.",
    ...
    "en": {
        ...
        "methodology_osint_title": "Open Source Research",
        ...
        "methodology_dorking_title": "Advanced Internet Research",
        "methodology_dorking_desc": "Advanced search techniques to identify documents, data leaks, and buried information not indexed by standard search engines.",
