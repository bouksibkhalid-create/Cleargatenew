        ...
        <section className="py-12 bg-white dark:bg-[#0F1419]">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    ...
                    <p className="text-base text-slate-600 dark:text-gray-400 max-w-3xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
                    ...
                    <Card className="bg-slate-50 dark:bg-[#1A1F2E] border-slate-200 dark:border-white/10 text-slate-900 dark:text-white">
                        <CardHeader>
                            ...
                            <p className="text-sm text-slate-500 dark:text-gray-400 mt-1">Complementary solutions</p>
                        </CardHeader>
                        <CardContent>
