...
export function SourceItem({ flag, name, description, features }: Source) {
    return (
        <div className="flex flex-col gap-3 pb-6 mb-6 border-b border-white/10 last:border-b-0 last:pb-0 last:mb-0">
            ...
            <ul className="flex flex-col gap-2">
                {features.map((feature, idx) => (
                    <li key={idx} className="text-sm text-gray-400 pl-6 relative">
